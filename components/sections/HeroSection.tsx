...
import { UFOLanding } from '@/components/animations/UFOLanding'
...
export function HeroSection() {
  return (
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden">
      ...
      >
        <div className="w-6 h-10 border-2 border-warm-cream/40 rounded-full p-1">
          <div className="w-1 h-2 bg-warm-cream/60 rounded-full mx-auto" />
        </div>
      </motion.div>
    </section>
  )

    ...
    <section className="py-section-lg">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <ScrollReveal variants={fadeIn} className="text-center mb-16">
          ...
          <p className="text-body-xl text-ink-muted font-body">Houston Strong Since 1967</p>
        </ScrollReveal>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          {features.map((feature, index) => (
            ...
            >
              ...
              <h3 className="text-h4 text-ink mb-2 font-display">{feature.title}</h3>
              <p className="text-body text-ink-muted font-body">{feature.description}</p>
            </ScrollReveal>
          ))}
        </div>
        ...
        >
          <div className="relative z-10">
            ...
            <p className="text-body-lg text-surface/80 font-body">
              We&apos;ve made over 2 million pies since 1967 - that&apos;s enough pies to reach the
              moon and back!
            </p>
          </div>
        </ScrollReveal>

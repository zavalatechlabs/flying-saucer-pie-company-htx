...
export const businessInfo: BusinessInfo = {
  ...
  about: {
    ...
    mission:
      'At Flying Saucer Pie Company, our goal is to serve delicious pies that are handmade fresh every day. We use high quality ingredients, time-tested recipes, & never use preservatives.',
  ...
  faqs: {
    freezing: {
      ...
      instructions:
        'Unbox the pie and wrap it tightly in foil. Put the foil wrapped pie back in the box - put box in freezer. Do NOT defrost - Frozen pie goes straight to the oven at 350°F for 30-45 mins.',

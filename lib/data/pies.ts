...
export const pies: Pie[] = [
  // ── FRUIT PIES ────────────────────────────────────────────────────────────
  {
    ...
    heroImage: '/images/pies/menu/apple-crumble-1.jpg',
    available: true,
    canFreeze: true,
  ...
  },
  {
    ...
    heroImage: '/images/pies/menu/apple-crumble-2.jpg',
  ...
  },
  {
    ...
    heroImage: '/images/pies/menu/blueberry-pie.jpg',
    imagePosition: 'center 80%',
    available: true,
    canFreeze: true,
    shelfLife: '3 days room temp, 4–5 days refrigerated',
  },
  {
    ...
    heroImage: '/images/pies/menu/pecan-pie.jpg',
    available: true,
    canFreeze: true,
    shelfLife: '3 days room temp, 4–5 days refrigerated',
  },
  ...
  // ── CREAM PIES ────────────────────────────────────────────────────────────
  {
    ...
    heroImage: '/images/pies/menu/cherry-lattice-pie.jpg',
    imagePosition: 'center 80%',
    available: true,
  ...
  },
  {
    ...
    heroImage: '/images/pies/menu/chocolate-swirl.jpg',
    available: true,
    shelfLife: '2–3 days refrigerated',
  },
  {
